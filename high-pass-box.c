...
#define GEGL_OP_META
#define GEGL_OP_NAME     high_pass_box
#define GEGL_OP_C_SOURCE high-pass-box.c
...
attach (GeglOperation *operation)
{
  ...
  blur = gegl_node_new_child (gegl, "operation", "gegl:box-blur", NULL);
  ...
  gegl_operation_meta_redirect (operation, "radius", blur, "radius");
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
                                 "name",        "gegl:high-pass-box",
                                 "title",       _("High Pass Box Sharpen"),
                                 "categories",  "frequency",
                                 "reference-hash", "x62261a5feb6c696f76cb80e68f4930e2",
                                 "reference-hashB", "xcf04bb714a173f1f71da8af283b8a894",
                                 "description",
                                 _("Enhances fine details using a reversal of Box Blur's algorithm. Blend modes Linear Light and Grain Merge make it sharpen."),
                                 NULL);
}
